    <div class="row">
      <div class="col-xs-12 col-md-12 col-lg-12">
        <footer>
          <ul class="list-group">
            <li id="ti"><h3 class="list-group-item-heading"><a href="javascript:void(0)">Timothy Longoria</a></h3><img id="timpic" class="img-responsive" src="http://media.timlongoria.com/t150.jpg"></li>
